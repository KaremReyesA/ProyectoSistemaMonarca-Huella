...
public class ModificarTicketDetalles_1 extends javax.swing.JFrame {

    public ModificarTicketDetalles_1() {
        initComponents();
...
void vaciarCombos() {
    ...
    private void btnEliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliActionPerformed
        ...
        if (jtVerArticulosPendientes.getSelectedRowCount() == 1) {
            ...
            totalRest = totalRest - monto;
            if (totalRest < 0) {
                totalRest=totalRest+monto;
                JOptionPane.showMessageDialog(null, "El precio del articulo es mayor que la deuda restante");
            } else {
                ...
                if (dialogResult == 0) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            lblTotalRestante.setText("" + totalRest);
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        float diferencia = totalNvo - Float.parseFloat(lblPrecioTotal.getText());
        totalRest = totalRest + diferencia;
        if (totalRest < 0) {
            totalRest=totalRest-diferencia;
            JOptionPane.showMessageDialog(null, "El precio del articulo es mayor que la deuda restante");
        } else {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        AgregarArticuloTicket_1 add = new AgregarArticuloTicket_1();
        add.lblId.setText(id);
        add.lblNombre.setText(nombre);
        add.lbltotal.setText(lblTotalRestante.getText());
        add.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarTicketDetalles_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarTicketDetalles_1().setVisible(true);
            }
        });
    }
