...
public class AgregarTicketDetalles extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            ...
            Logger.getLogger(AgregarTicketDetalles.class.getName()).log(Level.SEVERE, null, ex);
        }
        lblId.setText(""+folio);
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        AgregarTicketAgregarArticuloTicket add = new AgregarTicketAgregarArticuloTicket();
        AgregarTicketAgregarArticuloTicket.folio=folio;
