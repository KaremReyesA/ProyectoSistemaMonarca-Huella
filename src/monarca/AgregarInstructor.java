...
public class AgregarInstructor extends javax.swing.JPanel {
        ...
        try {
            ...
            if(rs.next()){
                if(rs.getString("celular")==null){
                    ...
                    labelIDInstructor.setText(rs.getString("id"));
            ...
            Logger.getLogger(AgregarInstructor.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try{
            ...
            if(inicial == 0){
                ...
                if(!nombre.isEmpty() && !aPaterno.isEmpty() && IcoCorreNombre.isVisible()&& IcoCorreApellidoP.isVisible()){
                    ...
                    AgregarInstructorP2 articulos = new AgregarInstructorP2();
