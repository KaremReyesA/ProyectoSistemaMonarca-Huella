...
public class VerInstructores extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        back.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 640, 170, 40));

        jButton3.setText("Ver Datos");
        back.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 640, 170, 40));
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            ...
            jTable1.getColumnModel().getColumn(1).setHeaderValue("Edad");
            jTable1.getColumnModel().getColumn(2).setHeaderValue("Cinta");
        }

        back.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 290, 780, 280));

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel3.setText("Buscar por nombre o apellido del Instructor");
