 ...
 * @author josue
 */
public class VerAdeudos extends javax.swing.JFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (jtArtPend.getSelectedRowCount() == 1) {
            ...
            VerTicketDetalles ver = new VerTicketDetalles();
    ...
    private void btnModActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModActionPerformed
        ...
        if (jtArtPend.getSelectedRowCount() == 1) {
            ...
            String monto_total = jtArtPend.getValueAt(fila, 3).toString();
            String monto_deuda = jtArtPend.getValueAt(fila, 4).toString();
            ModificarTicketDetalles ver = new ModificarTicketDetalles();
            ver.lblId.setText(folio);
            ver.lblNombre.setText(nombre);
            ver.lblTotalRestante.setText(monto_deuda);
            ModificarTicketDetalles.totalRest=Float.parseFloat(monto_deuda);
            ModificarTicketDetalles.total=Float.parseFloat(monto_total);
            ModificarTicketDetalles.folio=Integer.parseInt(folio);
            ver.lblTotal.setText(monto_total);
            ver.setVisible(true);
        } else {
            JOptionPane.showMessageDialog(null, "No se seleccionó ningun alumno, por favor seleccione uno.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerAdeudos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VerAdeudos().setVisible(true);
            }
        });
    }
