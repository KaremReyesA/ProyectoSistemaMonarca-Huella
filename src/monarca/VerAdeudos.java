 ...
 * @author Karem Ra
 */
public class VerAdeudos extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        if (jtArtPend.getColumnModel().getColumnCount() > 0) {
            jtArtPend.getColumnModel().getColumn(0).setHeaderValue("Folio");
            jtArtPend.getColumnModel().getColumn(1).setHeaderValue("Nombre completo");
            jtArtPend.getColumnModel().getColumn(2).setHeaderValue("Fecha");
            jtArtPend.getColumnModel().getColumn(3).setHeaderValue("Monto total");
            jtArtPend.getColumnModel().getColumn(4).setHeaderValue("Pendiente");
        }

        back.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 280, 690, 300));
    ...
    private javax.swing.JTable jtArtPend;
