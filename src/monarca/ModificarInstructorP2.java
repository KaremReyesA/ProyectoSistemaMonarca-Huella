...
public class ModificarInstructorP2 extends javax.swing.JPanel {
 public static int inicial = 0;
 public static String celular;
    public ModificarInstructorP2() {
        initComponents();
  ...
  try {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        //SELECT * FROM `usuario` ORDER BY `id` DESC LIMIT 1
         ModificarInstructor articulos = new ModificarInstructor();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!txtaDireccion.getText().isEmpty() && !txtTelefono1.getText().isEmpty()&& SiTelefono.isVisible()){
            ...
            try {
                ...
                modificarAlumno.setString(3, idNowModifyInst);
